...
- [x] **Slice 3b — bridge feed publisher** (deferred follow-up PR): unauthenticated read-only `/feed` WebSocket endpoint on the game server + bridge subscriber that posts world-scope envelopes to the configured Discord channel.
